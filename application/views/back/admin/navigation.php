...
if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){
    if($this->crud_model->admin_permission('vendor') ||
        ...
        <li <?php if($page_name=="vendor" ||
            ...
            <li>
                <a href="<?php echo base_url(); ?>home/vendor_logup/registration?created_user=<?php echo urlencode(base64_encode(base64_encode($this->session->userdata('admin_id'))))?>" target="_blank">
                    <i class="fa fa-circle fs_i"></i>
                    <?php echo translate('vendor_create');?>
                </a>
            </li>
